...
interface IAgentUnderwriterModel {
    ...
    function quote(address agent, uint256 amount, uint256 tenorDays, uint256 blendedScore, uint256 taskCoverageBps)
        external
        view
        returns (uint256 aprBps, uint256 confidenceBps, uint256 maxAmount);
}
