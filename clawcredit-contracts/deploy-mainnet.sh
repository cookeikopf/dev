#!/bin/bash
# ClawCredit Production Deployment Script
...
# Step 4: Deploy ClawCreditUltimateV3
echo "Step 4: Deploying ClawCreditUltimateV3 (MAIN CONTRACT)..."
...
forge verify-contract $CLAWCREDIT_V3 src/ClawCreditUltimateV3.sol:ClawCreditUltimateV3 --chain-id 8453 --watch &
...
echo ""
echo "BaseScan URLs:"
echo "https://basescan.org/address/$CLAWCREDIT_V3"
echo ""
