...
contract ClawCreditUltimateV3 is AccessControl, Pausable, ReentrancyGuard {
    ...
    function escrowTaskPayment(
        ...
        uint256 dueDate,
        bytes32 taskHash
    ) external nonReentrant returns (uint256 receivableId) {
    ...
    function requestLoan(
        ...
        loans[loanId] = Loan({
            ...
            taskCollateral: uint96(agents[msg.sender].taskBackedCredit > amount ? amount : agents[msg.sender].taskBackedCredit),
